    ...
    return (
        <div className={`relative ${className}`}>
            ...
            <input
                ...
                className="w-full pl-10 pr-4 py-2 border-0 bg-white dark:bg-slate-900 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
            />
        </div>
    );
};
