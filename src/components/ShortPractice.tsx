...
import { BookOpen, Play, Lock, Sparkles, ChevronRight, ClipboardCheck } from "lucide-react";
    ...
    return (
        <div className="space-y-3 w-full">
            <div className="flex items-center justify-between gap-3 px-4 sm:px-0">
                ...
                <button
                    onClick={() => navigate("/quizzes?category=practice")}
                    ...
                    return (
                        ...
                        >
                            {unit.image_url ? (
                                ...
                                >
                                    <ClipboardCheck className="w-12 h-12 text-white/50" />
                                </div>
                            )}
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-3 space-y-2">
                                <div className="flex items-center gap-1.5 text-[10px] font-bold text-white/80 uppercase tracking-wider">
                                    <ClipboardCheck className="w-3 h-3" /> {unit.code}
                                </div>
                                ...
                                <div className="flex items-center justify-between pt-1">
                                    ...
                                    {unlocked ? (
                                        <span className="flex items-center gap-1 text-[10px] font-bold text-white bg-emerald-600 px-2.5 py-1 rounded-full">
