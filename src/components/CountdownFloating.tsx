...
const UNIVERSAL_EXAMS: CountdownPlan[] = [
    {
        ...
        papers: ["Anatomy", "Physiology", "Pharmacology"],
    ...
    },
    {
        ...
        papers: ["Clinical Procedures", "Patient Care"],
        created_at: new Date().toISOString(),
        is_active: true,
    },
];
...
// =============================================
const CUSTOM_EXAMS_CACHE_KEY = "custom_exams_cache_v2";
const HIDDEN_EXAMS_KEY = "hidden_exams_v2";
