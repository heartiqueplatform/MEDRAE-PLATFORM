...
export default function ShareButtonsGroup({
    ...
    return (
        <div className="w-full max-w-lg mx-auto mt-6 overflow-hidden rounded-xl border border-gray-100 dark:border-gray-800 bg-white/80 dark:bg-muted/50 backdrop-blur-xl shadow-2xl shadow-blue-500/5">
