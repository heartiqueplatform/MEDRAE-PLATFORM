                ...
                <ul className="flex flex-col gap-2">
                  ...
                  {messages.map((msg, idx) => {
                    ...
                    return (
                      <li
                        key={msg.id}
                        className={`flex flex-col ${msg.user_id === currentUserId ? "items-end" : "items-start"} ${isSameSender ? "mt-1" : "mt-3"
                          }`}
                      >
                        {/* Avatar + Name */}
                        <div
                          className={`flex items-center gap-2 mb-1 min-h-[32px] ${msg.user_id === currentUserId ? "flex-row-reverse" : "flex-row"
                            }`}
                        >
                          <div className="flex-shrink-0">
                            <Avatar className="h-8 w-8 overflow-visible">
                              {msg.avatar_url ? (
                                <img
                                  src={msg.avatar_url || "/UsersAvatar.jpg"}
                                  alt={msg.sender_name}
                        ...
                        {/* Message Bubble */}
                        <div
                          className={`px-3 py-2 rounded-lg break-words max-w-[75%] relative group ${msg.deleted
                        ...
                        >
                          ...
                          {/* Metadata */}
                          <div
                            className={`mt-1 flex justify-end items-center gap-1 text-[10px] ${msg.user_id === currentUserId ? "text-green-400" : "text-green-200"
                              }`}
                          >
