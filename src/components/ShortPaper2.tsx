...
import { BookOpen, Play, Lock, Sparkles, ChevronRight, FileText } from "lucide-react";
...
const PAPER_NUMBER = 2;
const GRADIENT = "from-blue-500 to-blue-700";

export default function ShortPaper2({
    limit = 5,
    title = "Paper 2",
    subtitle = "Leadership, research & community health",
}) {
    ...
    return (
        <div className="space-y-3 w-full">
            <div className="flex items-center justify-between gap-3 px-4 sm:px-0">
                ...
                <button
                    onClick={() => navigate("/quizzes?category=paper2")}
                        ...
                        >
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-3 space-y-2">
                                <div className="flex items-center gap-1.5 text-[10px] font-bold text-white/80 uppercase tracking-wider">
                                    <FileText className="w-3 h-3" /> {unit.code}
                                </div>
