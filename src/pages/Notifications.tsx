...
export function Notifications() {
  ...
  return (
    <div className="flex justify-center items-start min-h-screen bg-transparent pt-0 px-1 sm:px-4">
      <div className="w-full max-w-3xl space-y-2 p-2 sm:p-4 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
