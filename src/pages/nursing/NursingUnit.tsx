...
function UnitCardSkeleton() {
    return (
        <div className="overflow-hidden rounded-2xl bg-white/70 shadow-sm backdrop-blur dark:bg-muted/30">
...
function TopicSkeleton() {
    return (
        <div className="rounded-2xl bg-white p-3 md:p-4 shadow-sm dark:bg-slate-900">
...
function UnitStatsSkeleton() {
    return (
        <div className="grid grid-cols-3 gap-2 md:gap-3">
            {[1, 2, 3].map((i) => (
                <div key={i} className="rounded-lg md:rounded-xl bg-white/70 p-2 md:p-3 text-center shadow-sm dark:bg-slate-950/40">
    ...
    return (
        <div className="min-h-screen bg-transparent text-slate-950 dark:text-white pb-20 md:pb-6">
            <section className="mx-auto flex w-full md:max-w-full md:px-4 lg:px-6 flex-col gap-4 md:gap-6 px-0 md:px-4 py-4 md:py-6 lg:px-8">
                    ...
                    <div className="relative">
                        ...
                        {loading ? (
                            ...
                            <div className="mt-4 md:mt-5 grid grid-cols-3 gap-2 md:gap-3">
                                <div className="rounded-lg md:rounded-xl bg-white/70 p-2 md:p-3 text-center shadow-sm dark:bg-slate-950/40">
                    ...
                    <div className="grid gap-3 md:gap-4 px-3 md:px-0">
                        {filteredUnits.map((unit, index) => {
                            ...
                            return (
                                <div
                                    key={unit.id}
                                    className="overflow-hidden rounded-2xl bg-white/70 shadow-sm backdrop-blur transition hover:bg-white hover:shadow-xl dark:bg-muted/30 dark:hover:bg-slate-900"
                                >
                                    <button
                                    ...
                                    <div className={`transition-all duration-300 ease-in-out ${isOpen ? "max-h-[2000px] opacity-100" : "max-h-0 opacity-0"}`}>
                                        <div className="border-t border-slate-200 bg-slate-50/70 p-3 md:p-4 dark:border-slate-800 dark:bg-slate-950/30">
                                            {isLoadingTopics ? (
                                                ...
                                                <div className="rounded-lg md:rounded-xl bg-white/70 p-3 md:p-4 text-xs md:text-sm text-slate-500 dark:bg-slate-900/70 dark:text-slate-400">
                                                ...
                                                <div className="grid gap-2 md:gap-3">
                                                    {filteredTopics.map((topic: any) => {
                                                        ...
                                                        return (
                                                            <div key={topic.id} className="group rounded-lg md:rounded-2xl bg-white p-3 md:p-4 shadow-sm transition hover:shadow-md dark:bg-slate-900">
                                                                <div className="flex items-start justify-between gap-3 md:gap-4">
                                                                    <div className="min-w-0">
                                                                        <div className="mb-1.5 md:mb-2 flex flex-wrap items-center gap-1.5 md:gap-2">
                ...
                <div className="flex items-center justify-center gap-1.5 md:gap-2 bg-emerald-50/80 px-3 md:px-4 py-2.5 md:py-3 text-xs md:text-sm font-semibold text-emerald-700 shadow-sm backdrop-blur dark:bg-emerald-400/10 dark:text-emerald-300 mx-3 md:mx-0 rounded-lg md:rounded-2xl">
