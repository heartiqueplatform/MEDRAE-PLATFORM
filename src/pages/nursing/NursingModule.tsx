    ...
    return (
        <div className="min-h-screen bg-transparent text-slate-950 dark:text-white pb-20 md:pb-6">
            <section className="mx-auto flex w-full md:max-w-full md:px-4 lg:px-6 flex-col gap-4 md:gap-6 px-1 md:px-4 py-4 md:py-6 lg:px-8">
                ...
                <div className="relative overflow-hidden rounded-xl bg-white/70 p-4 md:p-6 shadow-xl backdrop-blur-xl dark:bg-muted/30 sm:p-8">
                    ...
                    <div className="relative">
                        ...
                        {isPremium && !showSkeletons && (
                            <div className="mt-4 md:mt-5 flex items-center gap-2 md:gap-3 rounded-lg md:rounded-xl bg-gradient-to-r from-emerald-50 to-green-50 p-3 md:p-4 border-0 dark:from-emerald-400/10 dark:to-green-400/5 dark:border-emerald-400/20">
                ...
                <div className="grid gap-3 md:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 px-3 md:px-0">
                    {showSkeletons ? (
                        ...
                        filteredModules.map((mod, index) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`group relative overflow-hidden rounded-xl p-4 md:p-5 text-left shadow-sm backdrop-blur transition duration-200 hover:-translate-y-1 hover:shadow-xl ${isLocked
                                        ...
                                        : isUnlockedNow
                                            ...
                                            : "bg-white/70  hover:bg-white dark:bg-muted/30 dark:hover:border-emerald-500/60 dark:hover:bg-slate-900"
                                ...
                                >
                                    ...
                                    {/* Icon — top, horizontally centred */}
                                    <div className="relative flex justify-center">
                                        <div className={`flex h-12 w-12 md:h-14 md:w-14 shrink-0 items-center justify-center rounded-2xl text-white shadow-lg ${isLocked ? "bg-amber-400" : isUnlockedNow ? "bg-gradient-to-br from-emerald-500 to-green-600" : style.iconBg}`}>
                                            {isLocked ? <Lock className="h-5 w-5 md:h-6 md:w-6" /> : isUnlockedNow ? <Unlock className="h-5 w-5 md:h-6 md:w-6" /> : <Icon className="h-5 w-5 md:h-6 md:w-6" />}
                                        </div>
                                    </div>

                                    {/* Everything below — left aligned, like before */}
                                    ...
                                    <div className={`relative mt-4 md:mt-5 flex items-center gap-1.5 md:gap-2 text-xs md:text-sm font-semibold ${isLocked ? "text-amber-700 dark:text-amber-300" : "text-emerald-700 dark:text-emerald-300"}`}>
                                        {isLocked ? (
                                            <><Crown className="h-3.5 w-3.5 md:h-4 md:w-4" /> Unlock Premium — 399 KSh</>
                                        ) : isUnlockedNow ? (
                                            <><Sparkles className="h-3.5 w-3.5 md:h-4 md:w-4" /> Start learning — just unlocked!</>
                                        ) : (
                                            <><Sparkles className="h-3.5 w-3.5 md:h-4 md:w-4" /> Start module</>
                                        )}
                                    </div>
                                </button>
                            );
