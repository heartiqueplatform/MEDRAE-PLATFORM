...
export default function TermsPage() {
    ...
    return (
        <div className="w-full min-h-screen bg-white text-gray-900 py-10 px-2">
            <div className="max-w-4xl mx-auto space-y-2 text-sm text-gray-700">
                ...
                <section className="space-y-2">
                    ...
                    <p>
                        Medrae respects user privacy and collects information to improve services and ensure safe interactions. Users must not share others’ contact details without consent or misuse personal information. When meeting for transactions, always choose safe, public locations. Medrae is not responsible for accidents, theft, or damages that may occur during in-person exchanges. Users should exercise caution and common sense at all times.
                    </p>
                    ...
                    <h2 className="font-semibold text-xl">7. Compliance with Laws</h2>
                    <p>
                    ...
                    <h2 className="font-semibold text-xl">8. Account Suspension and Termination</h2>
                    <p>
                    ...
                    <h2 className="font-semibold text-xl">9. Updates to Terms & Conditions</h2>
                    <p>
