...
`;
  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex flex-col w-full md:max-w-full md:px-4 lg:px-6 mx-auto bg-background border border-0 shadow-sm rounded-xl overflow-hidden">
      {/* Header */}
