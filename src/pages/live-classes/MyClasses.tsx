        ...
        <div className="container mx-auto px-0 md:px-4 lg:px-6 py-4 md:py-8 max-w-full animate-pulse">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 md:gap-4 mb-4 md:mb-8 px-4 md:px-0 pt-4 md:pt-0 pb-3 md:pb-0">
                ...
                <div className="flex gap-2 w-full md:w-auto">
                    <div className="h-9 md:h-10 bg-gray-200 dark:bg-gray-700 rounded-lg w-28 md:w-32"></div>
                    <div className="h-9 md:h-10 bg-gray-200 dark:bg-gray-700 rounded-lg w-28 md:w-32"></div>
                </div>
            </div>
...
export const MyClasses = () => {
    ...
    return (
        <div className="container mx-auto px-0 md:px-4 lg:px-6 py-4 md:py-8 max-w-full">
            {/* Header - Mobile Native with Action Buttons */}
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 md:gap-4 mb-4 md:mb-8 px-4 md:px-0 pt-4 md:pt-0 pb-3 md:pb-0">
                <div>
                ...
                <div className="flex items-center gap-2 w-full md:w-auto">
                    <button
                        ...
                        className="flex-1 md:flex-none px-3 md:px-4 py-1.5 md:py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg text-[10px] md:text-sm font-medium transition-colors flex items-center justify-center gap-1.5 md:gap-2 hover:bg-gray-200 dark:hover:bg-gray-600"
                    >
                        <LayoutGrid className="h-3.5 w-3.5 md:h-4 md:w-4" />
                        Live Classes
                    </button>
                    <button
                        onClick={() => navigate('/live-classes/create')}
                        className="flex-1 md:flex-none px-3 md:px-4 py-1.5 md:py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-[10px] md:text-sm font-medium transition-colors flex items-center justify-center gap-1.5 md:gap-2"
                    >
                                ...
                                <div className="p-4 md:p-6">
                                    ...
                                    <div className="mt-3 md:mt-4 pt-3 md:pt-4 border-t border-gray-100 dark:border-gray-700">
                                        <div className={`flex items-center gap-1.5 md:gap-2 ${attendance.color}`}>
                                            <attendance.icon className="h-3.5 w-3.5 md:h-4 md:w-4 flex-shrink-0" />
                                    ...
                                    <div className="mt-3 md:mt-4 flex flex-wrap gap-1.5 md:gap-2">
                                        ...
                                        {isUpcoming && !isLive && (
                                            <button
                                                ...
                                                className="flex-1 px-3 md:px-4 py-1.5 md:py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg text-[10px] md:text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center justify-center gap-1.5 md:gap-2"
                                            >
